...
<script type="text/javascript">
    $(function (){
        $("#pay").click(function (){
            ...
            <%--//订单名称--%>
            <%--var ordername=${sessionScope.login}+orderNum;--%>
            location.href="${basepath}/client/payServlet?action=doPay&orderNum="+orderNum+"&allPrice="+allPrice+"&orderName=${sessionScope.login.loginName}&orderBody=${requestScope.orderInfo.createTime}";
            <%--location.href="${basepath}/client/payServlet?action=doPay";--%>
        })
    })
</script>
<!--Begin Header Begin-->
            ...
            <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
              <tr height="35">
                <td style="font-size:18px;">
                	感谢您在本店购物！您的订单已提交成功，请记住您的订单号: <font id="orderNum" color="#ff4e00">${requestScope.orderInfo.serialNumber}</font>
                </td>
              </tr>
              <tr>
                <td style="font-size:14px; font-family:'宋体'; padding:10px 0 20px 0; border-bottom:1px solid #b6b6b6;">
                	您选定的配送方式为: <font color="#ff4e00">申通快递</font>； &nbsp您选定的支付方式为: <font color="#ff4e00">支付宝</font>； &nbsp; &nbsp;您的应付款金额为: ￥<font id="allPrice" color="#ff4e00">${requestScope.orderInfo.cost}</font>
                </td>
              </tr>
              <tr>
                <td>
